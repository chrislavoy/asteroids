...
void UpdateBullets(Bullet *bullets, Asteroid *asteroids, Player *player, Texture2D bulletTexture, int maxBullets, int maxAsteroids, float frameTime, Sound asteroidExplosion);
